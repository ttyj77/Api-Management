...
function getGraph() {
    ...
    let start_date = document.getElementById('date').getAttribute("start_date");
    let end_date = document.getElementById('date').getAttribute("end_date");
    ...
    let data = {
        "start_date": start_date, "end_date":end_date, "code": orgCode,
    }

    $.ajax({
        url: "/mydata/periodChartData", type: "get", data: data,
